...
<YouTubeEmbed
  videoId="UjNtzovEUCw"
  url="https://youtu.be/UjNtzovEUCw"
...
<a href="https://employees.theworknumber.com/about" target="_blank" rel="noopener noreferrer">The Work Number</a> started in the 1990s as a product of TALX Corporation, built to automate employment and income verification so HR departments wouldn't have to field phone calls confirming where people worked. Equifax acquired TALX in 2007 and folded it into its workforce business.
...
5. **Submit the form.**
6. **Wait for Equifax to verify and apply the freeze.** Equifax processes freeze requests within about 3 days of receiving them, then mails you a confirmation that includes a PIN.
