...
If the employer uses a payroll-data database — The Work Number, the employment-data service many large companies report wages to, is the most common one — your verified W-2 history will show employer names and date ranges. A gap appears there as a stretch with no reported wages. It's visible, but it's still just a date range with nothing in it. No reason is attached, because the database doesn't store reasons. (If having that data sit in a database at all makes you uneasy, you can [freeze The Work Number](/blog/how-to-freeze-your-work-number-step-by-step) and control who sees it.)
